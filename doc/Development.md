# Development and Testing Guide <br/> Pip.Services Messaging for .NET
...
```bash
nuget pack pip-services3-messaging-dotnet.nuspec
```

Publish the package on nuget global repository

```bash
nuget push PipServices3.Messaging.<version>.nuspec -Source https://www.nuget.org/api/v2/package
```
